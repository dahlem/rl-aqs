...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd">
  ...
  <key id="key3" for="node" attr.name="service_rate" attr.type="float" />
  <key id="key4" for="node" attr.name="time_service_ends" attr.type="float" />
  <key id="key5" for="edge" attr.name="weight" attr.type="float" />
  <graph id="G" edgedefault="directed" parse.nodeids="canonical" parse.edgeids="canonical" parse.order="nodesfirst">
    <node id="n0">
      <data key="key0">7.26403</data>
      <data key="key1">0</data>
      <data key="key2">0</data>
      <data key="key3">17.7019</data>
    ...
    <node id="n9">
      ...
      <data key="key3">3.58952</data>
      <data key="key4">0</data>
    </node>
    <edge id="e0" source="n0" target="n1">
      <data key="key5">0.5</data>
    </edge>
    <edge id="e1" source="n0" target="n2">
      <data key="key5">0.5</data>
    </edge>
    <edge id="e2" source="n3" target="n0">
      <data key="key5">0.333333</data>
    </edge>
