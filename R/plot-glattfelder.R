...
des.plot.evo.eta.hat.groups <- function(prefix,
                                        group1=c("evo-avg-delay-control.dat"),
                                        group2=c("evo-avg-delay-control.dat"),
                                        group3=c("evo-avg-delay-control.dat"),
                                        group4=c("evo-avg-delay-control.dat"),
                                        ...
                                        ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-control-evo-etaHat.eps", sep=""), width=4.872, height=3.48)
  }
  ...
  if (length(group1) > 1) {
    ...
    p <- ggplot(df1, aes(x=time, y=etahat, linetype=factor(type)))
  } else {
    p <- ggplot(df1, aes(x=time, y=etahat))
  }
  ...
  if (length(group2) > 1) {
    ...
    p2 <- ggplot(df2, aes(x=time, y=etahat, linetype=factor(type)))
  } else {
    p2 <- ggplot(df2, aes(x=time, y=etahat))
  }
  ...
  if (length(group3) > 1) {
    ...
    p3 <- ggplot(df3, aes(x=time, y=etahat, linetype=factor(type)))
  } else {
    p3 <- ggplot(df3, aes(x=time, y=etahat))
  }
  ...
  if (length(group4) > 1) {
    ...
    p4 <- ggplot(df4, aes(x=time, y=etahat, linetype=factor(type)))
  } else {
    p4 <- ggplot(df4, aes(x=time, y=etahat))
  }
...
des.plot.evo.eta.100.groups <- function(prefix,
                                        group1=c("evo-avg-delay-control.dat"),
                                        group2=c("evo-avg-delay-control.dat"),
                                        group3=c("evo-avg-delay-control.dat"),
                                        group4=c("evo-avg-delay-control.dat"),
                                        ...
                                        ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-control-evo-eta100.eps", sep=""), width=4.872, height=3.48)
  }
  ...
  if (length(group1) > 1) {
    ...
    p <- ggplot(df1, aes(x=time, y=eta100, linetype=factor(type)))
  } else {
    p <- ggplot(df1, aes(x=time, y=eta100))
  }
  ...
  if (length(group2) > 1) {
    ...
    p2 <- ggplot(df2, aes(x=time, y=eta100, linetype=factor(type)))
  } else {
    p2 <- ggplot(df2, aes(x=time, y=eta100))
  }
  ...
  if (length(group3) > 1) {
    ...
    p3 <- ggplot(df3, aes(x=time, y=eta100, linetype=factor(type)))
  } else {
    p3 <- ggplot(df3, aes(x=time, y=eta100))
  }
  ...
  if (length(group4) > 1) {
    ...
    p4 <- ggplot(df4, aes(x=time, y=eta100, linetype=factor(type)))
  } else {
    p4 <- ggplot(df4, aes(x=time, y=eta100))
  }
