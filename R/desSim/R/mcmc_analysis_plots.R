...
des.kriging.mcmc.posterior.plot <- function(prefix="2d-shdf", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-posterior.eps", sep=""))
  }
...
des.kriging.mcmc.beta.plot <- function(prefix="2d-shdf", nonst="", idx="1", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain", nonst ,"-beta_", idx , ".eps", sep=""))
  }
...
des.kriging.mcmc.sigma.plot <- function(prefix="2d-shdf", nonst="", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain", nonst ,"-sigma.eps", sep=""))
  }
...
des.kriging.mcmc.theta.plot <- function(prefix="2d-shdf", idx="1", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-theta_", idx, ".eps", sep=""))
  }
...
des.kriging.mcmc.posterior.mean.plot <- function(prefix="2d-shdf", ps=TRUE) {
  if (file.exists(paste(prefix, "-chain-posterior-mean.dat", sep=""))) {
    if (ps) {
      des.postscript(paste(prefix, "-chain-posterior-mean.eps", sep=""))
    }
...
des.kriging.mcmc.beta.mean.plot <- function(prefix="2d-shdf", nonst="", idx="1", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain", nonst , "-beta_", idx , "-mean.eps", sep=""))
  }
...
des.kriging.mcmc.sigma.mean.plot <- function(prefix="2d-shdf", nonst="", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain", nonst, "-sigma-mean.eps", sep=""))
  }
...
des.kriging.mcmc.theta.mean.plot <- function(prefix="2d-shdf", idx="1", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-theta_", idx, "-mean.eps", sep=""))
  }
...
des.kriging.mcmc.autocorr.plot <- function(prefix="2d-shdf", var="beta", wopt, ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-normalised-autocorr-mass-", var, ".eps", sep=""))
  }
...
des.kriging.mcmc.tauintvsw.plot <- function(prefix="2d-shdf", var="beta", wopt, taui, ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-tauint_vs_w-", var, ".eps", sep=""))
  }
...
des.kriging.mcmc.beta.likeli.plot <- function(prefix="2d-shdf", idx="1", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-beta_", idx, "-likelihood.eps", sep=""))
  }
...
des.kriging.mcmc.sigma.likeli.plot <- function(prefix="2d-shdf", ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-sigma-likelihood.eps", sep=""))
  }
...
des.kriging.mcmc.theta.likeli.plot <- function(prefix="2d-shdf", idx=1, ps=TRUE) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-theta_", idx, "-likelihood.eps", sep=""))
  }
...
des.kriging.mcmc.beta.marginal.plot <- function(prefix="2d-shdf", idx="1", ps=TRUE, adj=1) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-beta_", idx , "-sampled.eps", sep=""))
  }
...
des.kriging.mcmc.sigma.marginal.plot <- function(prefix="2d-shdf", ps=TRUE, adj=1) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-sigma-sampled.eps", sep=""))
  }
...
des.kriging.mcmc.theta.marginal.plot <- function(prefix="2d-shdf", ps=TRUE, idx="1", adj=1) {
  if (ps) {
    des.postscript(paste(prefix, "-chain-theta_", idx, "-sampled.eps", sep=""))
  }
...
##   if (ps) {
##     des.postscript(paste(prefix, "-chain-nonst-eta", i, "_", j, "-likelihood.eps", sep=""))
##   }
...
##   if (ps) {
##     des.postscript(paste(prefix, "-nonst-tauint_vs_w-eta", i, "_", j, ".eps", sep=""))
##   }
...
##   if (ps) {
##     des.postscript(paste(prefix, "-nonst-normalised-autocorr-mass-eta", i, "_", j, ".eps", sep=""),
##                onefile=FALSE)
##   }
...
##   if (ps) {
##     des.postscript(paste(prefix, "-nonst-chain-eta", i, "_", j, "-mean.eps", sep=""))
##   }
...
##   if (ps) {
##     des.postscript(paste(prefix, "-nonst-chain-eta", dim, "_", idx, ".eps", sep=""))
##   }
