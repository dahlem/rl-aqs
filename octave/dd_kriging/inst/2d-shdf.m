...
function points = shdf_real()
  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-real.dat";
  samples = 100;
...
function chain = shdf_krig()
  ...
  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate.dat";
  samples = 100;
  ...
  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate-beta.dat";
  fd = fopen(outfile, "wt");
  fprintf(fd, "%14.6f\n", mean_chain.beta);
  fclose(fd);

  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate-sigma.dat";
  fd = fopen(outfile, "wt");
  fprintf(fd, "%14.6f\n", mean_chain.sigma);
  fclose(fd);

  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate-theta1.dat";
  fd = fopen(outfile, "wt");
  fprintf(fd, "%14.6f\n", mean_chain.theta1);
  fclose(fd);

  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate-theta2.dat";
  fd = fopen(outfile, "wt");
  fprintf(fd, "%14.6f\n", mean_chain.theta2);
  fclose(fd);
  
  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate-beta-sampled.dat";
  fd = fopen(outfile, "wt");
  fprintf(fd, "%14.6f\n", sampled.beta);
  fclose(fd);

  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate-sigma-sampled.dat";
  fd = fopen(outfile, "wt");
  fprintf(fd, "%14.6f\n", sampled.sigma);
  fclose(fd);

  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate-theta1-sampled.dat";
  fd = fopen(outfile, "wt");
  fprintf(fd, "%14.6f\n", sampled.theta1);
  fclose(fd);

  outfile = "../doc/2d/shdf/gauss/jeffrey/2d-shdf-surrogate-theta2-sampled.dat";
  fd = fopen(outfile, "wt");
  fprintf(fd, "%14.6f\n", sampled.theta2);
  fclose(fd);
