...
public:
    ...
    static tGraphSP createBBVGraph(boost::uint32_t p_size, boost::uint32_t p_max_edges,
                                   double p_edge_weight, double p_max_arrival_rate, double p_boost_arrival, double p_boost_edge,
...
private:
    ...
    static void advance(boost::uint32_t, tGraphSP,
                        ...
                        double, double, double, double, boost::uint32_t);
     ...
     */
    static void balance_vertex_strength(Vertex&, tGraphSP, double, double, double);
