...
{
public:
    LeaveHandler(dcommon::tQueueSP p_queue);
    ~LeaveHandler();
...
/** @typedef tLeaveHandlerSP
 * a type definition of the shared pointer of the leave handler
 */
typedef boost::shared_ptr <LeaveHandler> tLeaveHandlerSP;
